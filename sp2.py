...
L=['roar.txt', 'SRR4054281_2.fastq.gz', '316292K_S9_L001_R1_001.fastq.gz', 'BS546900_trimmoed/_/BS546900_reverse_paired.fastq.gz', 'Undetermined_trimmoed/Undetermined_forward_paired.fastq.gz', '/etc/usr/bin/SRR4054281_1.fastq.gz']
